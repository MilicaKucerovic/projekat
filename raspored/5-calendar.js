var cal = {
  ...
  hID:null, hStart:null, hEnd:null, hEml: null, hTxt:null, hColor:null,
  init : () => {
    ...
    cal.hEml = document.getElementById("email");
  ...
  // (G) DELETE EVENT
  del : () => { if (confirm("Обрисати догађај?")) {
    // (G1) FORM DATA
    let data = new FormData();
    data.append("req", "del");
